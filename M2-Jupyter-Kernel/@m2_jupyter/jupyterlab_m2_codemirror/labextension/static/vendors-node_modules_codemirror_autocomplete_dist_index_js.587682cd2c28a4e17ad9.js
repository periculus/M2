"use strict";
(self["webpackChunk_m2_jupyter_jupyterlab_m2_codemirror"] = self["webpackChunk_m2_jupyter_jupyterlab_m2_codemirror"] || []).push([["vendors-node_modules_codemirror_autocomplete_dist_index_js"],{
...
class ActiveSnippet {
    constructor(ranges, active) {
        this.ranges = ranges;
        this.active = active;
        this.deco = _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.Decoration.set(ranges.map(r => (r.from == r.to ? fieldMarker : fieldRange).range(r.from, r.to)), true);
    }
    map(changes) {
        let ranges = [];
...
//# sourceMappingURL=vendors-node_modules_codemirror_autocomplete_dist_index_js.587682cd2c28a4e17ad9.js.map