...
import { isRawDocFile, classifyFile, isAutoGenerated } from './doc_detection.js';
...
console.log(`  No autogen:   ${noAutoGenFiles} files | ${noAutoGenNodes} nodes | ${noAutoGenErrors} errors | ${noAutoGenRate.toFixed(2)}%  (informational: CODE only minus ${autoGenFiles} auto-generated files)`);
