...
// 2. 'auto_generated' — machine-generated data files (valid M2, stays in CODE_ONLY)
// 3. 'doc_heavy'      — valid M2 code wrapping documentation content (Macaulay2Doc/, *-doc.m2)
// 4. 'raw_doc'        — pure SimpleDoc markup, not M2 expression syntax
// 5. 'code'           — normal M2 code
//
...
// 'doc_heavy' and 'auto_generated' are informational only — these files stay in CODE_ONLY.
...
export function classifyFile(code, filePath) {
  ...
  // 2. Auto-generated data files (valid M2, stays in CODE_ONLY)
