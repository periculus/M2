...
const EXCLUDED = {
  ...
  'when':         'Clause keyword, handled by external tokenizer (WhenKw)',
  'of':           'Clause keyword, handled by external tokenizer (OfKw)',
  'in':           'Clause keyword, handled by external tokenizer (InKw)',
  'from':         'Clause keyword, handled by external tokenizer (FromKw)',
  'to':           'Clause keyword, handled by external tokenizer (ToKw)',
