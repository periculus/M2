...
// Based on the M2 language syntax and Pygments lexer
...
CodeMirror.defineMode("macaulay2", function() {
  ...
  var builtinFunctions = [
    ...
    "ancestor", "ancestors", "and", "ann", "annihilator", "any", "append",
    ...
    "borel", "cacheValue", "cancelTask", "canonicalBundle", "catch", "ceiling",
    ...
    "expectedReesIdeal", "expm1", "exponents", "export", "exportFrom",
    ...
    "nonspaceAnalyzer", "norm", "normalCone", "not", "notImplemented", "nullhomotopy",
    ...
    "options", "optP", "or", "orbits", "order", "orderedMonoidRing", "orphanedPackages",
    ...
    "profile", "Proj", "projectiveHilbertPolynomial", "promote", "protect",
    ...
    "then", "threadLocal", "throw", "time", "times", "timing", "toAbsolutePath",
    ...
    "try", "tutorial", "typicalValues", "ultimate", "unbag", "uncurry", "undocumented",
    ...
    "weightRange", "when", "whichGm", "while", "width", "wikipedia", "wrap",
    "xor", "youngest", "zero", "zeta", "ZZParser"
  ];
